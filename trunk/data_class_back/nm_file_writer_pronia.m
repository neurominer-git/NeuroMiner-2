...
%
%   DATA_OUTPUT=NM_FILE_WRITER_PRONIA (DATA_INPUT) writes a
%   text file "DATA_INPUT.type_YYYY_MM_DD_HH_MM_SS.txt" in the corrent
...
%
%   DATA_OUTPUT=NM_FILE_WRITER_PRONIA (DATA_INPUT,FILENAME) writes a

...
%STATUS (TEMPLATE_ENSEMBLE_LEARNING class) determines the status of a
%TEMPLATE_ENSEMBLE_LEARNING (TEVAL) object or array of TEVAL objects.
...
%   describing the status of the correspendent TEMPLATE_ENSEMBLE_LEARNING 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for TEMPLATE_ENSEMBLE_LEARNING class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for TEMPLATE_ENSEMBLE_LEARNING class objects 
%       with defined models and report property valid (success).
%       3 - 'invalid' - any other case.


%   RES=STATUS (R)
%   See also TEMPLATE_ENSEMBLE_LEARNING, APPLY

%   STATUS (TEMPLATE_ENSEMBLE_LEARNING class)  revision history:
...
for i=1:numel(r)
    ...
    %% Act: Get the variables to decide between the three status
        ...
        aux_success_report=aux.report.flag;

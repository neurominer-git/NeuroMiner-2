...
%WEIGHT_VECTOR (C_SVM_LIBSMV class) computes the WEIGHT VECTOR of the
%C_SVM_LIBSMV element R.
% RES=WEIGHT_VECTOR (R) returns a vector that corresponds to W the primal
%   solution of the linear SVM defined by C_SVM_LIBSMV class object
...
%
%   In the case that R is an array of C_SVM_LIBSMV class objects,
...
%   WEIGHT_VECTOR (C_SVM_LIBSMV class)  revision history:

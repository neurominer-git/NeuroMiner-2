...
%WEIGHT_VECTOR (nu_SVM_LIBSVM class) computes the WEIGHT VECTOR of the
%nu_SVM_LIBSVM element R.
% RES=WEIGHT_VECTOR (R) returns a vector that corresponds to W the primal
%   solution of the linear SVM defined by nu_SVM_LIBSVM class object
...
%
%   In the case that R is an array of nu_SVM_LIBSVM class objects,
...
%   WEIGHT_VECTOR (nu_SVM_LIBSVM class)  revision history:

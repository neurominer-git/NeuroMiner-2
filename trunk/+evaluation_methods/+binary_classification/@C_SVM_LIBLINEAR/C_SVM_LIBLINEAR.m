classdef C_SVM_LIBLINEAR
    ...
    %   The C_SVM_LIBLINEAR class integrates the C-SVM implementation of
    %   LIBLINEAR in NM2 for more info consult
    ...
    %     {1,2,3,5} :
    %     Description: Kernel to be used in the SVM
    ...
    %      Default value : type 2 and 5 -> 0.01 type 1 and 3 ->0.1.
    ...
    methods
        function obj =C_SVM_LIBLINEAR(paramet,model,reports)
            ...
            if nargin==0
               ...
               type=parameters({1},'int16',int16([1 1]),num2cell(int16([1 2 3 5])),'1 -- L2-regularized L2-loss support vector classification (dual)\n 2 -- L2-regularized L2-loss support vector classification (primal)\n3 -- L2-regularized L1-loss support vector classification (dual)\n5 -- L1-regularized L2-loss support vector classification\n Default  value - 1;)');
               ...
               paramet=struct('type',type,'cost',cost,'epsilon',epsilon,'class_weight',class_weight,'bias',bias,'train_eval',train_eval,'param_eval',param_eval);

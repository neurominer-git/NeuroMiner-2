...
%STATUS (kNN class) determines the status of a
%kNN (kNN) object or array of kNN objects.
...
%   describing the status of the correspendent kNN 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for kNN class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for kNN class objects 
...
%   STATUS (kNN class)  revision history:

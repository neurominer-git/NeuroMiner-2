...
%STATUS (C_SVM_LIBLINEAR class) determines the status of a
%C_SVM_LIBLINEAR (Logistic Regression) object or array of C_SVM_LIBLINEAR objects.
...
%   describing the status of the correspendent C_SVM_LIBLINEAR 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for C_SVM_LIBLINEAR class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for C_SVM_LIBLINEAR class objects 
%       with defined models and report property valid (success).
%       3 - 'invalid' - any other case.

%   RES=STATUS (R)
%   See also C_SVM_LIBLINEAR, APPLY

%   STATUS (C_SVM_LIBLINEAR class)  revision history:

...
%STATUS (TEMPLATE_EVALUATION class) determines the status of a
%TEMPLATE_EVALUATION (TEVAL) object or array of TEVAL objects.
...
%   describing the status of the correspendent TEMPLATE_EVALUATION 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for TEMPLATE_EVALUATION class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for TEMPLATE_EVALUATION class objects 
%       with defined models and report property valid (success).
%       3 - 'invalid' - any other case.


%   RES=STATUS (R)
%   See also TEMPLATE_EVALUATION, APPLY

%   STATUS (TEMPLATE_EVALUATION class)  revision history:

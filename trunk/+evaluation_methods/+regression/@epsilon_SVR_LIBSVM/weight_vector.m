...
%WEIGHT_VECTOR (epsilon_SVR_LIBSVM class) computes the WEIGHT VECTOR of the
%epsilon_SVR_LIBSVM element R.
% RES=WEIGHT_VECTOR (R) returns a vector that corresponds to W the primal
%   solution of the linear SVM defined by epsilon_SVR_LIBSVM class object
...
%
%   In the case that R is an array of epsilon_SVR_LIBSVM class objects,
...
%   WEIGHT_VECTOR (epsilon_SVR_LIBSVM class)  revision history:

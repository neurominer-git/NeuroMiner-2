...
%STATUS (nu_SVR_LIBSVM class) determines the status of a
%nu_SVR_LIBSVM (C_SVM) object or array of C_SVM objects.
...
%   describing the status of the correspendent nu_SVR_LIBSVM 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for nu_SVR_LIBSVM class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for nu_SVR_LIBSVM class objects 
%       with defined models and report property valid (success).
%       3 - 'invalid' - any other case.

%   RES=STATUS (R)
%   See also nu_SVR_LIBSVM, APPLY

%   STATUS (nu_SVR_LIBSVM class)  revision history:

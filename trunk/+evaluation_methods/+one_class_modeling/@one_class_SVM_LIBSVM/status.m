...
%STATUS (one_class_SVM_LIBSVM class) determines the status of a
%one_class_SVM_LIBSVM (C_SVM) object or array of C_SVM objects.
...
%   describing the status of the correspendent one_class_SVM_LIBSVM 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for one_class_SVM_LIBSVM class objects 
%       have no model defined and an empty report property.
%       2 - 'application_ready' - for one_class_SVM_LIBSVM class objects 
%       with defined models and report property valid (success).
%       3 - 'invalid' - any other case.

%   RES=STATUS (R)
%   See also one_class_SVM_LIBSVM, APPLY

%   STATUS (one_class_SVM_LIBSVM class)  revision history:

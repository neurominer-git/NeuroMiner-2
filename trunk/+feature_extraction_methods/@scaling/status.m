...
%STATUS (SCALING class) determines the status of a
%SCALING (TFE) object or array of FE objects.
...
%   describing the status of the correspendent SCALING 
%   class object.
%   Possible values are:
%
%       1 - 'estimation_ready' - for SCALING class 
%       objects have no model defined and an empty report property.
%       2 - 'application_ready' - for SCALING class 
%       objects with defined models and report property valid (success).
%       3 - 'invalid' - any other case.


%   RES=STATUS (R)
%   See also SCALING, APPLY

%   STATUS (SCALING class)  revision history:
%   Date of creation: 21 of October 2014 beta (Helena)

...
if nargin==1||nargin==2
    ...
    if strcmp('instances',mode)
        ...
        descriptor_ini=[ data(1).descriptor '_instances' num2str(size(data(1).data,1))];
        ...
        for i=2:numel(data)
            ...
            descriptor_ini=[ descriptor_ini ' | ' data(i).descriptor '_features' num2str(size(data(i).data,2))];
